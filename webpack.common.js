...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: "./src/pages/zip.html",
      inject: true,
      chunks: ["index","hamburger"],
      filename: "zip.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/zip-85.html",
      inject: true,
      chunks: ["index","hamburger", "tooltip"],
      filename: "zip-85.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/zip-95.html",
      inject: true,
      chunks: ["index","hamburger", "tooltip"],
      filename: "zip-95.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/zip-105.html",
      inject: true,
      chunks: ["index","hamburger", "tooltip"],
      filename: "zip-105.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/zip-125.html",
      inject: true,
      chunks: ["index","hamburger", "tooltip"],
      filename: "zip-125.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/screen.html",
      inject: true,
      chunks: ["index","hamburger"],
      filename: "screen.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/screen-85.html",
      inject: true,
      chunks: ["index","hamburger", "tooltip"],
      filename: "screen-85.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/screen-95.html",
      inject: true,
      chunks: ["index","hamburger", "tooltip"],
      filename: "screen-95.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/screen-105.html",
      inject: true,
      chunks: ["index","hamburger", "tooltip"],
      filename: "screen-105.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/screen-125.html",
      inject: true,
      chunks: ["index","hamburger", "tooltip"],
      filename: "screen-125.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/screen-markizorolety.html",
      inject: true,
      chunks: ["index","hamburger"],
      filename: "screen-markizorolety.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/screen-isola.html",
      inject: true,
      chunks: ["index","hamburger", "tooltip"],
      filename: "screen-isola.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/screen-standard.html",
      inject: true,
      chunks: ["index","hamburger", "tooltip"],
      filename: "screen-standard.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/smart-home.html",
      inject: true,
      chunks: ["index","hamburger"],
      filename: "smart-home.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/smart-home-torro-plato.html",
      inject: true,
      chunks: ["index","hamburger", "tooltip"],
      filename: "smart-home-torro-plato.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/smart-home-Somfy-Connexoon-RTS.html",
      inject: true,
      chunks: ["index","hamburger", "tooltip"],
      filename: "smart-home-Somfy-Connexoon-RTS.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/smart-home-Somfy-TaHoma Premium.html",
      inject: true,
      chunks: ["index","hamburger", "tooltip"],
      filename: "smart-home-Somfy-TaHoma Premium.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/smart-home-Coulisse-Motion-Wi-Fi.html",
      inject: true,
      chunks: ["index","hamburger", "tooltip"],
      filename: "smart-home-Coulisse-Motion-Wi-Fi.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/fotowoltaika.html",
      inject: true,
      chunks: ["index","hamburger"],
      filename: "fotowoltaika.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/fotowoltaika-markizy.html",
      inject: true,
      chunks: ["index","hamburger", "tooltip"],
      filename: "fotowoltaika-markizy.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/fotowoltaika-zip-sceen.html",
      inject: true,
      chunks: ["index","hamburger", "tooltip"],
      filename: "fotowoltaika-zip-sceen.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/fotowoltaika-fasadowy.html",
      inject: true,
      chunks: ["index","hamburger", "tooltip"],
      filename: "fotowoltaika-fasadowy.html",
    }), 
    new HtmlWebpackPlugin({
      template: "./src/pages/kontakt-wyslane.html",
      inject: true,
      chunks: ["index","hamburger"],
      filename: "kontakt-wyslane.html",
    }), 
